...
CommissionEmployee::CommissionEmployee(const string &first, const string &last, const string &ssn,int Age, double sales, double rate) : Employee(first, last, ssn, Age){
    setGrossSales(sales);
